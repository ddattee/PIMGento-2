 ...
 */
namespace Smile\Pimgento\Entities\Setup;
...
use Pimgento\Entities\Helper\Config;
    ...
    protected function convertSerializedDataToJson(ModuleDataSetupInterface $setup)
    {
        ...
        $queryModifier = $this->queryModifierFactory->create(
            ...
            [
                'values' => [
                    'path' => [
                        Config::CONFIG_PIMGENTO_EOF,
                        Config::CONFIG_PIMGENTO_EOL,
                        Config::CONFIG_PIMGENTO_ENCLOSURE,
                        Config::CONFIG_PIMGENTO_QUERY_NB,
                        Config::CONFIG_PIMGENTO_INSERTION_METHOD,
                        Config::CONFIG_PIMGENTO_LOCAL_DATA,
                    ]
                ]
            ]
        );
